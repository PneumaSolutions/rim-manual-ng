...
function RunningPlatform() {
  ...
  // platform detection function
    ...
    // Function to unhide the content div based on the identified platform
    React.useEffect(() => {
    ...
    // Call the showPlatform function once the page is loaded
...
export default RunningPlatform;
