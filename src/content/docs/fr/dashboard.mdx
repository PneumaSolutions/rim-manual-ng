...
Si votre organisation affecte un technicien d'assistance à un ensemble spécifique de machines, vous souhaitez probablement vous assurer qu'il n'a accès qu'à cet ensemble spécifique. C'est là qu'intervient le paramètre de contrôle d'accès pour les groupes cibles.  
