...
<MacOS>Prenez note du raccourci **Option+Shift+Backspace** mentionné, car il fera apparaître le menu RIM sur votre machine. Si vous utilisez exclusivement le clavier, c'est le seul moyen de renvoyer la saisie au clavier vers votre propre système.</MacOS>
