...
### 3.4.7
This build introduces the session recording capability across both platforms. This capability is free for anyone to use, and the cloud service is never utilized for processing the recording.
### 3.4.6
