...
Please do not hesitate to [send us feedback](https://getrim.app/feedback?state=%7B%22return_to%22%3A%22%2F%22%7D) should you run into any issues while using this feature, or if you have any comments or suggestions on how it can be improved.
### 3.4.6
