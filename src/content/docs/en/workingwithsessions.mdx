...
1. Access the "Start Session Recording" option off of the session menu. The following actions will occur as a result:
    ...
    * both parties will receive a notification that the recording has started.
...
1. The recording can be stopped via the "Stop Session Recording" option off the session menu.
    ...
    * The recording will then be saved to the "Videos" folder in your user directory. For added convenience, you will be automatically dropped into this folder via Explorer, allowing  you to send the recording to the user if desired.
    * Disconnecting the session stops the recording in the same manner described above.
...
1. The recording can be stopped via the "Stop Session Recording" option off the session menu.
    * Both parties will receive a notification following completion of the recording.
    * The recording will then be saved to the "Movies" folder in your user directory. For added convenience, you will be automatically dropped into this folder via Finder, allowing  you to send the recording to the user if desired.
    * Disconnecting the session stops the recording in the same manner described above.
