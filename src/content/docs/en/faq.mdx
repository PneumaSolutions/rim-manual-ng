...
Note that RIM will always attempt a direct peer-to-peer connection whenever possible. Relays are only used in situations where a direct peer-to-peer connection is not possible, even with NAT traversal.
