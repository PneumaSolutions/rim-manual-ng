...
Wenn Ihre Organisation einen Supporttechniker einer bestimmten Gruppe von Rechnern zuweist, möchten Sie wahrscheinlich sicherstellen, dass er nur auf diese bestimmte Gruppe Zugriff hat. Hier kommt die Einstellung der Zugriffskontrolle für Zielgruppen ins Spiel.  
...
Über das Dashboard können Sie die Details Ihres RIM-Abonnements leicht einsehen und verwalten. Wenn Sie auf den Link "Abonnement verwalten" klicken, können Sie:
