...
### 3.4.7
Diese Version führt die Funktion zur Aufzeichnung von Sitzungen auf beiden Plattformen ein. Diese Funktion kann von jedem kostenlos genutzt werden, und der Cloud-Dienst wird niemals für die Verarbeitung der Aufzeichnung verwendet. Aufnahmen werden derzeit im lokalen Videos-Ordner des steuernden Benutzers gespeichert, d. h. unter Windows im Ordner „Videos” und unter MacOS im Ordner „Movies”.
### 3.4.6
