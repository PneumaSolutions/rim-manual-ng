...
Die RIM-Versionen werden durch Überschriften auf Ebene 2 gekennzeichnet. Wesentliche Aktualisierungen mit mehreren Funktionen für beide Plattformen werden in Mac- und Windows-Unterüberschriften auf Ebene 3 unterteilt.
...
### 3.1.10
* Sie können nun optional einen Kommentar am Ende einer RIM-Sitzung hinzufügen. Die Sitzungskommentare können im RIM-Dashboard eingesehen werden.
...
### 3.1.4
* Unternehmenskunden können RIM jetzt mit einem MSI-basierten Installationsprogramm installieren.
