...
### 3.4.7
Diese Version führt die Funktion zur Aufzeichnung von Sitzungen auf beiden Plattformen ein. Diese Funktion kann von jedem kostenlos genutzt werden, und der Cloud-Dienst wird niemals für die Verarbeitung der Aufzeichnung verwendet.
### 3.4.6
