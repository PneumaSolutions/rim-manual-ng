...
* Wenn der Zielcomputer NVDA verwendet und die Option Tasten von anderen Anwendungen verwenden nicht aktiviert ist, kann die Reaktionsfähigkeit von RIM beeinträchtigt sein.
