...
Ja. Die beste Konfiguration wäre in diesem Fall eine Bereitstellung vor Ort, also nehmen Sie bitte [Kontakt mit uns auf](https://pneumasolutions.com/contact/), wenn Ihr Anwendungsfall davon abhängt.
...
1. Drücken Sie erneut Windows+R und geben Sie diesmal mmsys.cpl ein, um die Toneinstellungen zu öffnen.
