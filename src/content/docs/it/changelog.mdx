...
### 3.4.7
Questa versione introduce la funzionalità di registrazione delle sessioni su entrambe le piattaforme. Questa funzionalità è gratuita per tutti e il servizio cloud non viene mai utilizzato per l&#x27;elaborazione delle registrazioni.
### 3.4.6
