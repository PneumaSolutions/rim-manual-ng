...
<Windows>#### RIM funziona in background e, in tal caso, apparirà nell&#x27;elenco Alt+Tab?
...
RIM non apparirà nell&#x27;elenco Command+Tab, ma apparirà nei menu di stato che contengono le informazioni sulla batteria, sulla connessione WiFi, ecc.</MacOS>
...
<Windows>L&#x27;unica eccezione a questo è quando RIM è installato senza privilegi di amministratore sul lato di destinazione.</Windows>


<MacOS>L&#x27;unica eccezione a questo è la finestra di accesso di FileVault.
</MacOS>
...
<Windows>
Sebbene RIM venga eseguito nella schermata di accesso di Windows, l&#x27;accesso è comunque un&#x27;operazione che deve essere eseguita manualmente dall&#x27;utente di destinazione. In altre parole, RIM *non* effettuerà automaticamente l&#x27;accesso dell&#x27;utente.</Windows>


<MacOS>Nella maggior parte dei casi, in particolare quando è abilitata la crittografia del disco FileVault, l&#x27;utente di destinazione dovrà essere fisicamente presente per inserire manualmente la password. RIM non può essere avviato su un Mac crittografato prima che sia stato effettuato l&#x27;accesso completo.
</MacOS>
