...
- Disconnetti sessione (**Windows+Shift+D**): Termina la sessione.
    - Ricordare che questa opzione è disponibile per entrambe le parti della sessione.</Windows> 
...
1. Selezionare "Richiedi accesso non presidiato o su richiesta"
...
### Registrazione di una macchina sul vostro conto RIM
...
### Creazione di una scorciatoia per una sessione non presidiata
...
| Azione | Comando |
| ---------------------------------------- | ------------------- |
| Accedere al menu RIM | Windows+Shift+Backspace |
...
## Riferimento ai comandi chiave
    ...
    Azione | Comando
    --- | ---
    Accesso al menu RIM | Opzione+Maiusc+Backspace
