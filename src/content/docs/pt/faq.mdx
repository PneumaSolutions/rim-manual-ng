...
### Ouvindo o áudio do microfone de uma de suas máquinas pessoais (Windows)
...
1. Pressione a tecla end para chegar a 0% e, em seguida, pressione a seta para cima uma vez para chegar a 1%. Como você pode ver, o RIM não leva em consideração o volume real do computador de destino ao emitir o áudio.
...
1. Uma vez nas configurações de som, acesse a guia de gravação (Ctrl+Tab).
1. Selecione o microfone ou o dispositivo de entrada de linha que deseja ouvir e, em seguida, acesse as propriedades com Alt+P.
1. Uma vez nas propriedades, CTRL+Tab na guia de escuta e marque a caixa de seleção "Listen to this Device" (Escutar este dispositivo).
1. CTRL+Tab mais uma vez na seção Levels (Níveis) e ajuste o ganho do microfone para um nível que seja suficiente para você. Pressione Enter quando terminar.
