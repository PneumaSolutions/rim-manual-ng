...
Se você for um administrador de rede que não tem o RIM instalado, basta fazer o login em sua conta no site do RIM e o painel será exibido.
...
Se a sua organização atribui um técnico de suporte a um conjunto específico de máquinas, você provavelmente quer garantir que ele só tenha acesso a esse conjunto específico. É aí que entra a configuração de controle de acesso para grupos-alvo.  
...
1. Em seguida, você tem a opção de atribuir um nome de baixo. Qualquer máquina provisionada por meio desse pacote de instalação terá esse nome de base atribuído a ela.
...
O painel permite que você visualize e gerencie facilmente os detalhes de sua assinatura do RIM. Ao clicar no link "gerenciar assinatura", você pode:
