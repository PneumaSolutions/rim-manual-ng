...
Digamos, por exemplo, que seu grupo de trabalho esteja espalhado por vários locais diferentes. Ou talvez você queira designar grupos de máquinas para os técnicos de manutenção de rotina. Os grupos-alvo permitem que você faça exatamente isso. Para fazer isso, basta clicar no botão "Create Target Group" (Criar grupo de destino), nomear o grupo e enviar.  
