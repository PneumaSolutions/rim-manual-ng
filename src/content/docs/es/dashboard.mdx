...
Si sus organizaciones asignan un técnico de soporte a un conjunto específico de máquinas, probablemente quiera asegurarse de que sólo tienen acceso a ese conjunto específico. Aquí es donde entra en juego la configuración del control de acceso para los grupos de destino.  
