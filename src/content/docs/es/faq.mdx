...
1. Escribe sndvol y pulsa Intro.
1. Pulsa la tecla fin para llegar al 0%, luego pulsa la flecha arriba una vez para llegar al 1%. Como puede ver, RIM no tiene en cuenta el volumen real de la máquina de destino a la hora de emitir su audio.
...
1. Una vez en los ajustes de sonido, accede a la pestaña de grabación (Ctrl+Tab).
1. Selecciona el micrófono o el dispositivo de entrada de línea que quieras escuchar y, a continuación, accede a las propiedades con Alt+P.
1. Una vez en las propiedades, CTRL+Tab a la pestaña escuchar, y marca la casilla "Escuchar este dispositivo".
1. CTRL+Tabulador una vez más a la sección Niveles, y ajusta la ganancia del micrófono a un nivel que sea suficiente para ti. Pulsa Intro cuando hayas terminado.
