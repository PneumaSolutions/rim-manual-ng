...
<Windows>#### ¿RIM se ejecuta en segundo plano? Si es así, ¿aparecerá en mi lista Alt+Tab?
...
RIM no aparecerá en su lista de Comando+Tab, pero sí aparecerá en los menús de estado que contienen información sobre la batería, la conexión WiFi, etc.</MacOS>
...
<Windows>La única excepción a esto es cuando RIM se instala sin privilegios de administrador en el lado del destino.</Windows>


<MacOS>La única excepción a esto es la ventana de inicio de sesión de FileVault.
</MacOS>
...
<Windows>
Aunque RIM se ejecutará en la pantalla de inicio de sesión de Windows, el inicio de sesión sigue siendo una tarea que debe realizar manualmente el usuario de destino. En otras palabras, RIM *no* iniciará sesión automáticamente en el usuario.</Windows>


<MacOS>En la mayoría de los casos, especialmente cuando el cifrado de disco FileVault está habilitado, el usuario de destino deberá estar físicamente presente para introducir manualmente la contraseña. RIM no puede iniciarse en un Mac cifrado antes de que se haya iniciado sesión completamente.
</MacOS>
