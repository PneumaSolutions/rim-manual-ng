...
* Si la máquina de destino está utilizando NVDA y tiene desmarcadas las teclas Handle de otras aplicaciones, la capacidad de respuesta de RIM puede bloquearse.
