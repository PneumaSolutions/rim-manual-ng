...
### 3.4.7
Deze versie introduceert de mogelijkheid om sessies op beide platforms op te nemen. Deze functie is voor iedereen gratis te gebruiken en de cloudservice wordt nooit gebruikt voor het verwerken van de opnames.
### 3.4.6
