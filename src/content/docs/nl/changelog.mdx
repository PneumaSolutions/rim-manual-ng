...
Versies van RIM worden aangeduid met kopjes op niveau 2. Substantiële updates met meerdere functies voor beide platformen worden onderverdeeld in Mac- en Windows-subrubrieken op niveau 3.

### 3.3.3

* We hebben nu genoeg vertrouwen in de lokalisatie van RIM om het uit bèta te halen. Dus RIM gebruikt nu standaard de voorkeurstaal van uw systeem en we hebben het label "BETA" uit de taalselector verwijderd.
...
wordt aan het eind van de sessie de speciale configuratie van VoiceOver afgesloten en wordt VoiceOver weer teruggezet naar de oorspronkelijke toestand
