...
1. Klik op "Installer bouwen" Je krijgt de downloadlink te zien die je naar het klembord kunt kopiëren en naar je eindgebruiker kunt sturen. Je kunt het installatieprogramma ook rechtstreeks downloaden voor gebruik bij massale implementaties.
