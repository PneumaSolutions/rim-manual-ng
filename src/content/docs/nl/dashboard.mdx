...
Als je organisaties een supporttechnicus toewijzen aan een specifieke set machines, dan wil je er waarschijnlijk voor zorgen dat ze alleen toegang hebben tot die specifieke set. Dit is waar de instelling voor toegangsbeheer voor doelgroepen om de hoek komt kijken.  
...
Merk op dat alle organisatiebeheerders automatisch toegang krijgen om alle groepen te beheren die onder de organisatie zijn aangemaakt.
