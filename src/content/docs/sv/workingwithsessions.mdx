...
Nu är du redo att utföra de uppgifter som behöver göras på klientsidan. Om du behöver återgå till att styra din egen maskin öppnar du RIM-menyn och väljer sedan alternativet "Minimera sessionen". Du kommer att återgå till din maskin tills du växlar tillbaka till sessionsfönstret eller trycker på Windows+Shift+Backspace igen. När du går tillbaka till sessionsfönstret kommer tangentbords- och musinmatningar återigen att riktas till klientdatorn.
...
- Visa anslutningsdetaljer: Ger en detaljerad översikt över din anslutning och målmaskinen. Informationen inkluderar:
    ...
    - Processer som körs
    - Installerade paket
- Koppla bort sessionen (**Windows+Shift+D**): Avslutar sessionen.
    - Kom ihåg att detta alternativ är tillgängligt för båda sidor av sessionen.</Windows> 
...
1. Vid det här laget har fjärråtkomstmodulen initialiserats fullständigt och du kommer att höra tal när du styr fjärrdatorn. Om du vill stänga av talutmatningen tillfälligt trycker du på Insert eller Capslock+S en gång för att stänga av den och sedan på samma kommando två gånger för att aktivera den igen.

Om du kör en skärmläsare på den styrande datorn kommer fjärrtillgänglighetsmodulen från och med nu att starta automatiskt under fjärrsessioner där fjärrdatorn inte har en skärmläsare igång. Om du kör en annan skärmläsare än NVDA kommer RIM att koppla ur den skärmläsaren och sedan växla över dig till NVDA. Om du behöver stoppa fjärrtillgänglighetsmodulen på fjärrdatorn för att starta en annan skärmläsare, går du helt enkelt till alternativet "Stoppa fjärrtillgänglighet" i RIM-menyn.
</Windows>
<MacOS>
...
1. Du kommer att bli tillfrågad om vilken typ av anslutning du vill konfigurera. Dina alternativ är:
    ...
    1. Prompt: I den här konfigurationen visas ett meddelande som informerar användaren om att du ansluter till deras dator. De måste trycka på Option+Shift+Y på macOS, eller Windows+Shift+Y på Windows, om de vill acceptera anslutningen.
...
Om du inte längre vill att din maskin ska styras obevakat kan du återkalla styrenhetens åtkomst. Du behöver inte vara i en session för att göra detta.
<Windows>
...
| Åtgärd | Kommando |
| ---------------------------------------- | ------------------- |
öppna RIM-menyn | Windows+Shift+Backspace | Minimera sessionen | Windows+Shift+M
...
<MacOS>
## Hänvisning till tangentkommandon
