...
Tveka inte att [skicka feedback till oss](https://getrim.app/feedback?state=%7B%22return_to%22%3A%22%2F%22%7D) om du stöter på problem när du använder den här funktionen eller om du har kommentarer eller förslag på hur den kan förbättras.
### 3.4.6
