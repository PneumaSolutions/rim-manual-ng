...
### 3.4.7
Denna version introducerar funktionen för sessionsinspelning på båda plattformarna. Funktionen är gratis för alla att använda, och molntjänsten används aldrig för att bearbeta inspelningen.
### 3.4.6
