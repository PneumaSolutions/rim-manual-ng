...
### 3.4.7
Denna version introducerar funktionen för sessionsinspelning på båda plattformarna. Funktionen är gratis för alla att använda, och molntjänsten används aldrig för att bearbeta inspelningen. Inspelningar sparas för närvarande i den kontrollerande användarens lokala videomapp, det vill säga &quot;Videos&quot; i Windows och &quot;Movies&quot; i MacOS.
### 3.4.6
