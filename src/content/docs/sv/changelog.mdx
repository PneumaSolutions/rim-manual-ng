...
## 3.3.0
Denna uppdatering tillför en mängd nya funktioner över hela linjen, samt plattformsspecifika revideringar. Allmänna tillägg inkluderar:
...
### Windows
* Berättaren talar nu konsekvent RIM-aviseringar
* Lagt till en icke-administratörsfallback

### Mac OS
* Lagt till en avinstallerare som nås via Om-skärmen som helt och rent tar bort RIM, inklusive Karabiner Virtual HID-drivrutinen
...
* När du startar en obevakad session stöder RIM nu dubbelklickning på en målgrupp eller målmaskin.
...
* Implementerar omstart och återanslutning för Mac-mål, inklusive både standardomstart och nödomstart.
    * Precis som vid obevakad åtkomst visas inte RIM på macOS-inloggningsskärmen på grund av plattformsbegränsningar, särskilt FileVault. Målanvändaren måste därför logga in igen innan RIM kan återansluta.
...
## 0.11.0
* Funktionen för omstart och återanslutning är nu implementerad. Med det nya alternativet Reboot and Reconnect på styrenhetens RIM-meny kan du göra antingen en standard- eller nödomstart och automatiskt fortsätta sessionen när omstarten är klar. RIM återansluter även om målmaskinen startas om av någon annan anledning, t.ex. när ett installationsprogram startar om maskinen.
...
## 0.10.5
Den här versionen innehåller några förändringar under huven. I synnerhet har vi inkluderat uppdateringar av installationen och underliggande paket för att åtgärda problem som gör att installationen hänger sig.
## 0.10.4
