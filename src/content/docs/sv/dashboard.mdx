...
Beroende på hur din organisation ser ut kan det finnas vissa funktioner som du inte vill att din personal ska ha tillgång till. Som organisationsadministratör kan du välja vilka funktioner du vill ge de personuppgiftsansvariga tillgång till. På skärmen "Restrictions", som du kommer åt via menyn "Organization", kan du konfigurera dessa behörigheter.

De behörigheter som kan växlas inkluderar:
* Tillåt den personuppgiftsansvarige att vända sessionen
    * Om det här alternativet är avmarkerat försvinner alternativet "Vänd session" från sessionsmenyn och kortkommandot fungerar inte.
* Tillåt styrenheten att starta en röstkonversation
    * Om det här alternativet är avmarkerat försvinner kryssrutan "Starta röstkonversation" från skärmen "Ge fjärrhjälp", liksom menyalternativet i sessionsmenyn.
* Tillåt styrenheten att begära obevakad åtkomst
    * Om detta alternativ inte är markerat försvinner alternativet att begära obevakad åtkomst från sessionsmenyn.
* Tillåt att text och filer överförs mellan maskiner via urklipp
    * Om detta alternativ är avmarkerat kommer RIM att ignorera all aktivitet i urklipp.
* Tillåt styrenheten att låsa målmaskinen
    * Om detta alternativ är avmarkerat försvinner alternativet att låsa målmaskinen från sessionsmenyn.

När du har konfigurerat behörigheterna på ett tillfredsställande sätt aktiverar du knappen "Uppdatera". Ändringarna kommer inte att påverka några aktiva sessioner vid den tidpunkt då behörigheterna ändras. De kommer dock att gälla för alla framtida sessioner utan att det krävs en omstart av klienten.
...
När detta är gjort visas en tabell med konton som har tillgång till den här gruppen. Under varje konto finns en knapp för att "Återkalla åtkomst". Denna knapp kräver ingen ytterligare bekräftelse.  
...
Användaren kan välja att antingen svara ja eller nej till installationen. Om du svarar nej avbryts installationen. När installationsprogrammet är klart får användaren ett meddelande om att maskinen nu är inställd för fjärråtkomst.
...
När du klickar på "Avbryt automatisk förnyelse" kommer du att bli ombedd att bekräfta, varefter din prenumeration kommer att ställas in så att den löper ut i slutet av den aktuella perioden.
